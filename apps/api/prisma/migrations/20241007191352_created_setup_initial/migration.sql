...
-- CreateEnum
CREATE TYPE "WalletType" AS ENUM ('PERSONAL', 'ORGANIZATIONAL');
...
-- CreateEnum
CREATE TYPE "SubscriptionType" AS ENUM ('NONE', 'ACTIVE', 'CANCELLED');
...
CREATE TABLE "users" (
    ...
    "password_hash" TEXT,
    "avatar_url" TEXT,
    "subscription" "SubscriptionType" NOT NULL DEFAULT 'NONE',
